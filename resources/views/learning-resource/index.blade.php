                            ...
                            <table class="table table-hover table-striped">
                                ...
                                @foreach($grades as $index => $grade)
                                    ...
                                    <tr>
                                        ...
                                        <td> R {{ $total_fees }}</td>
                                        <td>
                                            <a title="Edit Grade" class="btn btn-primary" href="/grades/{{ $grade->id }}/edit"><i class="fa fa-edit"></i></a>
                                            <a title="More Details" class="btn btn-warning" href=""><i class="fa fa-history"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
